    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
                ...
                <div className="mt-3">
                    ...
                    {updateInfo?.available && (
                        <div className="mt-2 text-xs text-blue-600">
                            {t('about.update_available', { version: updateInfo.version ?? '' })}
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">{t('about.what_makes_different')}</h2>
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.model_title')}</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">{t('about.model_desc')}</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.works_title')}</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">{t('about.works_desc')}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-blue-50 rounded p-3">
                <p className="text-s text-blue-800">
                    <span className="font-bold">{t('about.coming_soon').split(':')[0]}:</span> {t('about.coming_soon').split(':').slice(1).join(':')}
                </p>
            </div>

            {/* CTA Section - Compact */}
            <div className="text-center space-y-2">
                <h3 className="text-medium font-semibold text-gray-800">{t('about.cta_title')}</h3>
